...
public class CameraController : MonoBehaviour
{
    ...
    public float yaw = 0;
    public float zoom = 0;
    public bool ActivateTranslation = true;
    public bool ActivateZoom = true;
    public bool ActivateRotation = true;
    public Transform cameraTransform;
    public Transform cameraTarget;
    public int ROTATE_BUTTON = 0;//1;
    public int TRANSLATE_BUTTON = 1;//2;
    void Start()
    {
        isRotating = false;
        isTranslating = false;
    ...
    void Update()
    {
        ...
        if (ActivateTranslation)handleTranslationInput(interval);
        if (ActivateZoom)handleZoomInput(interval);
        if (ActivateRotation)handleRotationInput(interval);
